  ...
  const track = useCallback((label_event = false, value_event = false) => {
    if (typeof analytics !== 'undefined' && label_event !== false && value_event !== false) {
      analytics('event', 'project_interaction', {
        label: label_event,
        project_name: '2022-hbs_report_fr',
      ...
      <div className="content_wrapper content_wrapper_1">
        <div className="content_container">
          ...
          <div className="unctad_logo_container">
            <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2022-handbook_of_statistics/' : './'}assets/img/unctad_logo_fr.svg`} alt="UNCTAD logo" />
          </div>
